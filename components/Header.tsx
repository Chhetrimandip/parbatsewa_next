      ...
      <div className="mx-auto flex max-w-[1200px] items-center justify-between">
        ...
        <div className="flex items-center gap-3">
          ...
          <button
            ...
            className="rounded-[5px] border border-white/20 px-3 py-[9px] text-[11px] font-semibold tracking-[0.5px] text-white transition-all hover:border-red-soft/60 hover:text-red-soft"
          >
            {lang === 'en' ? 'नेपाली' : 'EN'}
          </button>
